        ...
        <div className="flex items-center space-x-6">
          <Link href="/" className="flex items-center space-x-2.5 font-bold text-white tracking-tight">
            ...
            <div className="flex flex-col">
              <span className="font-semibold text-sm leading-tight text-white">Virtual Computer Lab</span>
              <span className="text-[10px] text-gray-400 font-normal leading-tight">Classroom Screen Monitoring</span>
            </div>
          </Link>
